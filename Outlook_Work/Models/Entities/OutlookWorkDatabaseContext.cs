...
namespace Outlook_Work.Models.Entities
{
    public partial class OutlookWorkDatabaseContext : DbContext
    {
        ...
        private OutlookWorkDatabaseContext()
        {
        }

        private OutlookWorkDatabaseContext(DbContextOptions<OutlookWorkDatabaseContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Orderreportaccounting> Orderreportaccounting { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;user=root;database=outlook_work_db;password=12345;", x => x.ServerVersion("8.0.25-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Accounting>(entity =>
            {
                ...
                entity.HasIndex(e => e.CodeDirector)
                    .HasName("FK_Accounting_User_idx");

                entity.Property(e => e.Idaccounting).HasColumnName("idaccounting");

                entity.Property(e => e.Date).HasColumnType("date");

                entity.HasOne(d => d.CodeDirectorNavigation)
                    .WithMany(p => p.Accounting)
                    .HasForeignKey(d => d.CodeDirector)
            ...
            modelBuilder.Entity<Orderreportaccounting>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("orderreportaccounting");

                entity.HasIndex(e => e.IdAccounting)
                    .HasName("FK_All_Accounting_idx");

                entity.HasIndex(e => e.IdOrder)
                    .HasName("FK_All_Order_idx");

                entity.HasIndex(e => e.IdReport)
                    .HasName("FK_All_Report_idx");
                ...
                entity.HasOne(d => d.IdAccountingNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdAccounting)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_All_Accounting");

                entity.HasOne(d => d.IdOrderNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdOrder)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_All_Order");

                entity.HasOne(d => d.IdReportNavigation)
                    .WithMany()
                    .HasForeignKey(d => d.IdReport)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_All_Report");
            });
